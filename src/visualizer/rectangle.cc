...
Rectangle::Rectangle(glm::vec2 &corner, float width, float height, ci::ColorA &color) : top_left_corner_(corner),
...
float Rectangle::GetHeight() { return height_; }
float Rectangle::GetWidth() { return width_; }
